...
desc: See the Logos plugin API changelog for version 1.0! Find breaking changes, deprecations, new features, and updated documentation. Try Logos for free.
---
...
[https://doc.plugins.logos.app/](https://doc.plugins.logos.app/)
- New samples repository with lots of samples to use the API:
[https://github.com/logos/logos-plugins-samples](https://github.com/logos/logos-plugins-samples)
...
- Changed types names to remove the Logos prefix. So for example: <code class="language-js">LogosShape</code> becomes <code class="language-js">Shape</code>; <code class="language-js">LogosFile</code> becomes <code class="language-js">File</code>, and so on. Check the [API documentation](https://doc.plugins.logos.app/) for more details.
- Changes on the <code class="language-js">logos.on</code> and <code class="language-js">logos.off</code> methods.
Previously you had to send the original callback to the off method in order to remove an event listener. Now, <code class="language-js">logos.on</code> will return an *id* that you can pass to the <code class="language-js">logos.off</code> method in order to remove the listener.

Previously:
```js
logos.on(‘pagechange’, myListener); // Register an event listener
logos.off(‘pagechange’, myListener); // Remove previously registered listener
```

Now:
```js
const id = logos.on(‘pagechange’, myListener);
logos.off(id);
```
...
- Change some names to better align with the names in Logos's UI.
  - type <code class="language-js">frame</code> is now <code class="language-js">board</code>:
    - <code class="language-js">LogosFrame</code> is now <code class="language-js">Board</code>
    - <code class="language-js">logos.createFrame</code> changed to <code class="language-js">logos.createBoard</code>
    ...
    - <code class="language-js">LogosFrameGuideX</code> now <code class="language-js">GuideX</code>
  - type<code class="language-js">rect</code> is <code class="language-js">rectangle</code>
    - <code class="language-js">LogosRectangle</code> is now <code class="language-js">Rectangle</code>
  - type<code class="language-js">circle</code> is<code class="language-js">ellipse</code>
    - <code class="language-js">LogosCircle</code> is now <code class="language-js">Ellipse</code>
    - <code class="language-js">logos.createCircle</code> changed to <code class="language-js">logos.createEllipse</code>
  - type<code class="language-js">bool</code> is<code class="language-js">boolean</code>
    - <code class="language-js">LogosBool</code> is now <code class="language-js">Boolean</code>
...
- Adds method logos.viewport.zoomToShapes to change the viewport to the shapes.

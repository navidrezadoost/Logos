...
|----------|--------|--------|--------------|
| **CRDT Engine** | Operation latency | **268ns** | 3.7x faster than external design tool |
| **Layout Engine** | 1k node layout | **15.2us** | 13x faster than external design tool |
...
| **Text Shaping** | Per glyph | **630ns** | 3x faster than external design tool |
